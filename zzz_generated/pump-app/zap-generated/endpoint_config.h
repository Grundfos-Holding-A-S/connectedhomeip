    ...
    {                                                                                                                              \
        ...
        { 0x00000000, ZAP_TYPE(INT16U), 2, ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE),                             \
          ZAP_MIN_MAX_DEFAULTS_INDEX(0) },                                  /* identify time */                                    \
            ...
            { 0x00000003, ZAP_TYPE(INT16U), 2, 0, ZAP_EMPTY_DEFAULT() },        /* Tolerance */                                    \
            { 0x00000010, ZAP_TYPE(INT16S), 2, 0, ZAP_SIMPLE_DEFAULT(0x0000) }, /* ScaledValue */                                  \
            { 0x00000011, ZAP_TYPE(INT16S), 2, 0, ZAP_SIMPLE_DEFAULT(0) },      /* MinScaledValue */                               \
            { 0x00000012, ZAP_TYPE(INT16S), 2, 0, ZAP_SIMPLE_DEFAULT(0) },      /* MaxScaledValue */                               \
